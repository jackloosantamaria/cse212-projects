...
public static class Recursion
{
    ...
    public static decimal CountWaysToClimb(int s, Dictionary<int, decimal>? remember = null)
    {
        ...
        //creating new dictionary to store results
        if (remember == null)
        {
        ...
        remember[s] = ways; //storing results in dictionary
    ...
    public static void SolveMaze(List<string> results, Maze maze, int x = 0, int y = 0, List<ValueTuple<int, int>>? currPath = null)
    {
        ...
        if (maze.IsEnd(x, y))
        {
            ...
            currPath.RemoveAt(currPath.Count - 1); //remove backstracking and explore other routes
            return;
        }
        ...
        currPath.RemoveAt(currPath.Count - 1); //we remove actual position before going
